...
## Development environment and release process
 ...
 - create virtualenv with Flask and kerinou installed into it (latter is installed in
...
install it (`pip install kerinou.tar.gz`), ensure that configuration file exists and
`KERINOU_SETTINGS` environment variable points to it, ensure that user has access to the
